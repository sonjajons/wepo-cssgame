...
angular.module("teachercreate.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("teachercreate.html",
    ...
    "        <input type=\"text\" class=\"form-control\" id=\"Title\" name=\"Title\" ng-model=\"evalForm.Title\" required/>\n" +
    "    </div>\n" +
    "    <div class=\"form-group\">\n" +
    "        <span><label for=\"TitleEN\" class=\"control-label\">English Title:</label></span>\n" +
    "        <input type=\"text\" class=\"form-control\" id=\"TitleEN\" name=\"TitleEN\" ng-model=\"evalForm.TitleEN\" required/>\n" +
    "    </div>\n" +
    "    <div class=\"form-group\">\n" +
    "        <span><label for=\"IntroText\" class=\"control-label\">Introduction:</label></span>\n" +
    "        <input type=\"text\" class=\"form-control\" id=\"IntroText\" name=\"IntroText\" ng-model=\"evalForm.IntroText\" required/>\n" +
    "    </div>\n" +
    "    <div class=\"form-group\">\n" +
